...
public class ClientServiceImpl implements ClientService {
    ...
    public ClientServiceImpl(ClientRepository clientRepository, ClientConverter clientConverter, BusinessRepository businessRepository) {
     ...
     */
    @Override
    public List<ClientDto> getAll(Long businessId, Boolean isActive) {
     ...
     */
    @Override
    public ClientDto getById(Long businessId, Long id, Boolean isActive) {
        logger.debug("Into get entity service method with business id => {} and client id => {}", businessId, id);
        Optional<Client> optionalClient;

        if (isActive) {
            optionalClient = clientRepository.findActiveById(businessId, id);
        } else {
     ...
     */
    @Override
    public ClientDto update(Long businessId, Long id, ClientDto clientDto) {
     ...
     */
    @Override
    public Boolean delete(Long businessId, Long id) {

        logger.debug("Into delete entity service method with business id => {} and client id => {}", businessId, id);
        //Validate
        if (clientRepository.findActiveById(businessId, id).isEmpty()) {
            logger.error("Resource doesn't exist!");
            throw new ResourceNotFoundException("Resource doesn't exist!");
        }
        Client client = clientRepository.getById(id);
        logger.debug("Fetching client entity by id => {} from DB using repository", businessId);
