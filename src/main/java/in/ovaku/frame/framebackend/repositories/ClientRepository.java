...
public interface ClientRepository extends JpaRepository<Client, Long> {
    ...
    Optional<Client> findActiveById(@Param("businessId") Long businessId, @Param("id") Long id);
     ...
     */
    @Query("SELECT c from Client c where c.business.id=:id AND c.isActive=true")
    List<Client> findAllActiveByBusinessId(@Param("id") Long id);
}
